        ...
        <AnimatePresence>
         {showSplash && (
           <motion.div
             ...
             animate={{ opacity: 1 }}
             exit={{ opacity: 0 }}
             className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-950/90 backdrop-blur-xl p-3 sm:p-6 overflow-y-auto"
           >
    ...
    <SwipeableCard cardId="status-breakdown" onDismiss={() => handleDismissCard('status-breakdown')}>
      ...
      >
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="p-2 bg-gradient-to-br from-amber-500 to-amber-700 rounded-xl shadow-md shadow-amber-500/30">
    ...
    <SwipeableCard cardId="visual-insights" onDismiss={() => handleDismissCard('visual-insights')}>
      ...
      >
        <div className="flex items-center justify-between mb-1">
          ...
          <span className="p-2 bg-gradient-to-br from-purple-500 to-purple-700 rounded-xl shadow-md shadow-purple-500/30">
    ...
    <SwipeableCard cardId="budget-card" onDismiss={() => handleDismissCard('budget-card')}>
      ...
      >
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="p-2 bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl shadow-md shadow-blue-500/30">
    ...
    <SwipeableCard cardId="employment-card" onDismiss={() => handleDismissCard('employment-card')}>
      ...
      >
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="p-2 bg-gradient-to-br from-teal-500 to-teal-700 rounded-xl shadow-md shadow-teal-500/30">
