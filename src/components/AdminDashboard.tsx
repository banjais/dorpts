  ...
  const analyticsCards = useMemo(() => [
    {
      ...
      icon: <MapPin size={20} className="text-slate-600 dark:text-slate-300" />,
    },
    {
    ...
    },
    {
      ...
      bgColor: 'bg-slate-200 dark:bg-slate-800',
      borderColor: 'border-slate-300 dark:border-slate-600',
      icon: <Activity size={20} className="text-slate-600 dark:text-slate-300" />,
    },
    {
      ...
      icon: <Gauge size={20} className="text-emerald-700 dark:text-emerald-300" />,
    },
