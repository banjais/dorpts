...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    splashPurpose: 'Combined KPI data from all DOR offices, updated by office admins.',
    idpts: 'IDPTS',
    trendView: 'Trends',
  ...
  ne: {
    ...
    splashPurpose: 'सबै सडक विभाग कार्यालयका समेकित KPI डेटा, कार्यालय प्रशासकहरूद्वारा अपडेट।',
    idpts: 'IDPTS',
    trendView: 'प्रवृत्ति',
...
const defaultLanguageContext: LanguageContextType = {
  language: (typeof localStorage !== 'undefined' && localStorage.getItem('language') === 'ne') ? 'ne' : 'en',
  setLanguage: () => {},
  t: (key: string) => {
    const lang: Language = (typeof localStorage !== 'undefined' && localStorage.getItem('language') === 'ne') ? 'ne' : 'en';
    return translations[lang]?.[key] || translations['en']?.[key] || key;
  },
  translateUnit: (unit: string) => unit,
  translatePeriod: (period: string) => period,
  translateCategory: (category: string) => category,
  translateOffice: (name: string) => dataTranslateOffice(name, (typeof localStorage !== 'undefined' && localStorage.getItem('language') === 'ne') ? 'ne' : 'en'),
};
