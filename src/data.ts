...
export function translateOffice(name: string, language: 'en' | 'ne'): string {
  ...
  const dict: [RegExp, string][] = [
    [/सडक डिभिजन/g, 'Road Division'],
    [/सडक विभाग/g, 'Department of Roads'],
    [/योजना कार्यालय/g, 'Project Office'],
    [/सडक योजना/g, 'Road Project'],
    [/सडक आयोजना/g, 'Road Project'],
    [/आयोजना निर्देशनालय/g, 'Project Directorate'],
    [/निर्देशनालय/g, 'Directorate'],
    [/यान्त्रिक कार्यालय/g, 'Mechanical Office'],
    [/पुल योजना/g, 'Bridge Project'],
    [/पुल सेक्टर/g, 'Bridge Sector'],
    [/हेभी ईक्युमेन्ट डिभिजन/g, 'Heavy Equipment Division'],
    ...
    [/धरान/g, 'Dharan'],
    [/इटहरी/g, 'Itahari'],
    [/बिराटनगर/g, 'Biratnagar'],
    [/विराटनगर/g, 'Biratnagar'],
    [/वीरगंज/g, 'Birgunj'],
    [/नेपालगंज/g, 'Nepalgunj'],
    [/सुर्खेत/g, 'Surkhet'],
    [/धनगढी/g, 'Dhangadhi'],
    [/हेटौँडा/g, 'Hetauda'],
    [/भरतपुर/g, 'Bharatpur'],
    [/जनकपुर/g, 'Janakpur'],
    [/चन्द्रनिगाहपुर/g, 'Chandranigahpur'],
    [/धनकुटा/g, 'Dhankuta'],
    [/इलाम/g, 'Ilam'],
    [/दमक/g, 'Damak'],
    [/लाहान/g, 'Lahan'],
...
export function parseGoogleSheetsCSV(csvText: string): {
  ...
  const annualProgressIndex = findColIndex(['बार्षिक प्रगति', 'वार्षिक प्रगति', 'annual progress', 'हाल सम्म', 'हालसम्म']) !== -1 ? findColIndex(['बार्षिक प्रगति', 'वार्षिक प्रगति', 'annual progress', 'हाल सम्म', 'हालसम्म']) : 10;
